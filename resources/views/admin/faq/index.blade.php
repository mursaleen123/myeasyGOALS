                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                @can('role-create')
                                    <!--begin::Add Role-->
                                    <a href="{{ route('get.faq.form') }}" class="btn btn-primary">
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        @foreach ($faqs as $key => $faq)
                                            <tr>
                                                ...
                                                <td class="col-20">{{ $faq->question }}</td>
                                                <td class="faq-answer" title="{{ $faq->answer }}">
                                                    {{ Str::words($faq->answer, 20, '...') }}</td>
                                                <td class="col-5">{{ $faq->is_active == 'true' ? 'Active' : 'Not Active' }}
                                                </td>
                                                <td class="col-10">
                                                    <a class="btn btn-primary" href="{{ route('edit.faq', $faq->id) }}">Edit</a>

                                                    {!! Form::open(['method' => 'GET', 'route' => ['destroy.faq', $faq->id], 'style' => 'display:inline']) !!}
