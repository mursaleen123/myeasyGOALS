...
<head>
    ...
    <title><?php echo e(config('app.name', 'myeasyGOALS')); ?></title>
    ...
    <script src="https://cdn.tiny.cloud/1/di1zpy9jrnnv17xwmfn0vu1hl7nfmdxtiuakuilj4js4jdwr/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        tinymce.init({
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin.admin-nav','data' => []]); ?>
<?php $component->withName('admin.admin-nav'); ?>
...
<?php endif; ?>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin.admin-header','data' => []]); ?>
...
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('admin/assets/js/custom/modals/create-app.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/assets/js/custom/modals/upgrade-plan.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\myeasyGOALS\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>