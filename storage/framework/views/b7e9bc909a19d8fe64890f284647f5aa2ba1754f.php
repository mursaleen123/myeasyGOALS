        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <!--begin::Add user-->
                                <a href="<?php echo e(route('get.faq.index')); ?>" class="btn btn-primary">
                                    Back
                                </a>
                                <!--end::Add user-->
                            </div>
                    ...
                    <!--end::Card header-->
                    <?php echo Form::open(['route' => 'store.faq', 'method' => 'POST', 'class' => 'w-100 position-relative mb-3']); ?>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                ...
                                <!--end::Label-->
                                <?php echo Form::text('question', null, ['placeholder' => 'Write Faq Question Here?', 'class' => 'form-control']); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myeasyGOALS\resources\views/admin/faq/create.blade.php ENDPATH**/ ?>