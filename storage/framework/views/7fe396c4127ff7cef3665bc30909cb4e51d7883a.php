                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-list')): ?>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="roles_table">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><img src="<?php echo e(asset('admin/assets/media/books/1.png')); ?>" width="100" height="100"></td>
                                        <td>ABc</td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myeasyGOALS\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>